...
void main_task(void* arg)
{
	...
	while(1) {
		...
		*/
		line_orientation_data.rotation_matrix[0] = line_mpu_raw_data.magnet[0];
		line_orientation_data.rotation_matrix[1] = line_mpu_raw_data.magnet[1];
		line_orientation_data.rotation_matrix[2] = line_mpu_raw_data.magnet[2];
		normalize_matrix(line_orientation_data.rotation_matrix);
		transpose_matrix(line_orientation_data.rotation_matrix, line_orientation_data.rotation_matrix_transpose);
