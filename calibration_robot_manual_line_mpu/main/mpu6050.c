...
void readMPURawData(){
	...
	//GYRO X
	highByte = i2c_receive(0, 105, 67, 1);
	lowByte = i2c_receive(0, 105, 68, 1);
	mpu_pos.gyro_x = gyroSensFactor*(int16_t)((highByte << 8) | lowByte);
	//GYRO Y
	highByte = i2c_receive(0, 105, 69, 1);
	lowByte = i2c_receive(0, 105, 70, 1);
	mpu_pos.gyro_y = gyroSensFactor*(int16_t)((highByte << 8) | lowByte);
	//GYRO Z
	highByte = i2c_receive(0, 105, 71, 1);
	lowByte = i2c_receive(0, 105, 72, 1);
	mpu_pos.gyro_z = gyroSensFactor*(int16_t)((highByte << 8) | lowByte);
	
	//ACCEL X
	highByte = i2c_receive(0, 105, 59, 1);
	lowByte = i2c_receive(0, 105, 60, 1);
	mpu_pos.accel_x = accelSensFactor*(int16_t)((highByte << 8) | lowByte);
	//ACCEL Y
	highByte = i2c_receive(0, 105, 61, 1);
	lowByte = i2c_receive(0, 105, 62, 1);
	mpu_pos.accel_y = accelSensFactor*(int16_t)((highByte << 8) | lowByte);
	//ACCEL Z
	highByte = i2c_receive(0, 105, 63, 1);
	lowByte = i2c_receive(0, 105, 64, 1);
