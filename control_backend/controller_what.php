			...
			if ( isset( $_POST['username'] ) && isset( $_POST['email'] ) && isset( $_POST['password'] ) ) {
				...
				if((filter_var($sanitized_email, FILTER_VALIDATE_EMAIL) && $sanitized_email == $_POST['email']) || $sanitized_email == ""){
					if($sanitized_password == $_POST['password']){
						$con = new mysqli("dedivirt2155.your-server.de", "dedivirk_1_w", "u6Dp8FMXU9cHesje", "drachenbaendiger");
						...
						if($result2 == NULL){
							...
							if ($con->query($sql) === TRUE) {
								...
								if($sanitized_email == ""){
									...
									$con = new mysqli("dedivirt2155.your-server.de", "dedivirk_1_r", "qXYDf1rvFnGubY9Z", "drachenbaendiger");
